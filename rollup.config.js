    ...
    plugins: [
      alias({
        entries: [
          {
            find: "react",
            replacement: "@bpmn-io/properties-panel/preact/compat",
          },
      ...
      copy({
        targets: [
          {
            src: "node_modules/@bpmn-io/properties-panel/assets/**/*.css",
            dest: "dist/assets",
          },
...
function externalDependencies() {
  return (id) => {
    return (
      nonbundledDependencies.find((dep) => id.startsWith(dep)) &&
