...
export default class BsimImporter {
    ...
    constructor(eventBus, moddle, translate, modeling) {
        ...
        this._eventBus.on("element.click", (e) =>
            console.log(getBusinessObject(e.element))
        );
    }
    ...
    initTree(event) {
        ...
        var visitor = {
            definitions: function (definitions) {
                ...
                if (
                    definitions.get("bsim:timetables").get("bsim:timetable")
                        .length === 0
                ) {
                ...
                if (
                    definitions
                        ...
                        .get("bsim:dynamicResource").length === 0
                ) {
            ...
            element: function (element, ctx) {
                ...
                if (is(element, "bpmn:Process")) {
                    ...
                    if (!laneRes) {
                        ...
                        laneRes.set(
                            "id",
                            moddle.ids.nextPrefixed("Resource", laneRes)
                        );
